...
#if defined(COMMUNITY_MODULE_PALETTEFX_ENABLE)
...
#define PALETTEFX_USER_0_ENABLE
// #define PALETTEFX_USER_1_ENABLE
// #define PALETTEFX_USER_2_ENABLE
// #define PALETTEFX_USER_3_ENABLE
