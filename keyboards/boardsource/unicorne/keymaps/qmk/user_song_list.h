...
#define MEGALOVANIA_SHORT \
  E__NOTE(_D4),  E__NOTE(_REST),  E__NOTE(_D4), E__NOTE(_REST), Q__NOTE(_D5), Q__NOTE(_REST),Q__NOTE(_A4),Q__NOTE(_REST),Q__NOTE(_REST), \
  Q__NOTE(_AF4), Q__NOTE(_REST),Q__NOTE(_G4),Q__NOTE(_REST), H__NOTE(_F4), Q__NOTE(_D4), Q__NOTE(_F4), Q__NOTE(_G4),
